...
class TestLocalSmartIntegration(unittest.TestCase):
    ...
    @patch("src.pc.controllers.local_smart_ctrl.MinutesService.get_available_models")
    ...
    def test_complete_optimization_decision_flow(self, mock_specs, mock_models):
        ...
        with patch("src.pc.controllers.local_smart_ctrl.threading.Thread") as mock_thread:
