...
from src.platforms.common.ui.views.chat_bot_view import ChatBotView, ChatMessage
...
class TestChatBotViewIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch("src.platforms.common.ui.views.chat_bot_view.threading.Thread"):
    ...
    @patch("src.platforms.common.ui.views.chat_bot_view.history_mgr.search_hybrid")
    def test_rag_worker_retrieval_and_llm_call(self, mock_search):
        ...
        self.assertEqual(len(self.view.chat_history.controls), 1)
        # Verify AI蜉ｩ逅・name check is not strictly needed but good for visual
