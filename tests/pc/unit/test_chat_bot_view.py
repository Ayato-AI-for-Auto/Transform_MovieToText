...
from src.pc.ui.views.chat_bot_view import ChatBotView, ChatMessage
...
class TestChatBotViewIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch("src.pc.ui.views.chat_bot_view.threading.Thread"):
    ...
    @patch("src.pc.ui.views.chat_bot_view.history_mgr.search_hybrid")
