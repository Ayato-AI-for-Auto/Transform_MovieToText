...
from src.core.event_bus import event_bus, EVENT_TRANSCRIPTION_FINISHED, EVENT_STATUS_UPDATE
...
def test_env(tmp_path):
    ...
    with patch("src.core.transcription_service.history_mgr", history_mgr), \
...
def test_live_recording_integration_abort(test_env):
    ...
    with patch("src.recorder.visual_recorder.visual_recorder.start"), \
        ...
        meeting_id = service.start_live_recording(
            model_name="m",
            source="System",
